...
Workspace installation of the official [UI UX Pro Max skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/tree/7f69fed6a2717900085f1bc3b263721f8ba025e2), pinned to commit `7f69fed6a2717900085f1bc3b263721f8ba025e2` (MIT; see `LICENSE`). The entrypoint is adapted for GitHub Copilot on Windows; bundled scripts, data, and references are unmodified.
...
The search script lives inside this workspace skill directory. Run the commands below from the project root; from any other working directory, resolve the script to its absolute path first. Searches use Python's standard library, run locally, and make no network calls. Do not persist design-system documents unless the user explicitly requests them.

```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "<query>" --domain <domain>
```
...
```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "<keyword>" --stack <stack>
```
...
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "keyboard focus modal" --domain ux

# Step 4: stack guidelines
python -B ".\.github\skills\ui-ux-pro-max\scripts\search.py" "suspense streaming bundle" --stack nextjs
```
