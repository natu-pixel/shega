...
- The opening hall, stage hardware and procedural LED columns render before downloaded assets finish. Separate Suspense boundaries keep the crowd and artwork from hiding the entire Bermel world on a slow connection. An accessible loading notice covers both the initial JavaScript load and subsequent 3D asset requests, then disappears when downloads complete; Reading view remains available.
